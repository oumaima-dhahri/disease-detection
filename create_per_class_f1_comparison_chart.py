...
# Save figure
output_file = 'per_class_f1_comparison_chart.png'
...
print(f"  - Classes with F1 ≥ 95%: {sum(1 for c in convnext_f1 if c >= 95)}")
print(f"  - Classes with F1 < 70%: {sum(1 for c in convnext_f1 if c < 70)}")
print("="*60)
