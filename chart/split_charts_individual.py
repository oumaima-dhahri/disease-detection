...
def create_individual_chart_files():
    """Create separate image files for each chart type"""
    ...
    plt.title('Training Accuracy Over Epochs - All Models', fontsize=16, fontweight='bold', pad=20)
    ...
    plt.ylim(0, 1)
    plt.tight_layout()
    plt.savefig('01_training_accuracy_chart.png', dpi=300, bbox_inches='tight')
    print("Saved: 01_training_accuracy_chart.png")
    plt.close()
    ...
    plt.title('Validation Accuracy Over Epochs - All Models', fontsize=16, fontweight='bold', pad=20)
    plt.xlabel('Epoch', fontsize=14)
    ...
    plt.ylim(0, 1)
    plt.tight_layout()
    plt.savefig('02_validation_accuracy_chart.png', dpi=300, bbox_inches='tight')
    print("Saved: 02_validation_accuracy_chart.png")
    plt.close()
    ...
    plt.title('Training Loss Over Epochs - All Models', fontsize=16, fontweight='bold', pad=20)
    plt.xlabel('Epoch', fontsize=14)
    ...
    plt.yscale('log')
    plt.tight_layout()
    plt.savefig('03_training_loss_chart.png', dpi=300, bbox_inches='tight')
    print("Saved: 03_training_loss_chart.png")
    plt.close()
    ...
    plt.title('Validation Loss Over Epochs - All Models', fontsize=16, fontweight='bold', pad=20)
    plt.xlabel('Epoch', fontsize=14)
    ...
    plt.yscale('log')
    plt.tight_layout()
    plt.savefig('04_validation_loss_chart.png', dpi=300, bbox_inches='tight')
    print("Saved: 04_validation_loss_chart.png")
    plt.close()
    ...
    plt.title('Final Performance Comparison - All Models', fontsize=16, fontweight='bold', pad=20)
    ...
    plt.tight_layout()
    plt.savefig('05_final_performance_comparison_chart.png', dpi=300, bbox_inches='tight')
    print("Saved: 05_final_performance_comparison_chart.png")
    plt.close()
    ...
    plt.title('Best Validation Accuracy Ranking - All Models', fontsize=16, fontweight='bold', pad=20)
    ...
    plt.tight_layout()
    plt.savefig('06_best_validation_accuracy_ranking_chart.png', dpi=300, bbox_inches='tight')
    print("Saved: 06_best_validation_accuracy_ranking_chart.png")
    plt.close()
    
    return model_data

def create_individual_model_charts():
    """Create separate chart files for each model"""
    ...
    print("\nCreating individual model chart files...")
    ...
    for model_name, data in model_data.items():
        ...
        plt.title(f'{model_name} - Training Accuracy', fontsize=16, fontweight='bold', pad=20)
        plt.xlabel('Epoch', fontsize=14)
        plt.ylabel('Training Accuracy', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.ylim(0, 1)
        plt.tight_layout()
        plt.savefig(f'{safe_name}_training_accuracy.png', dpi=300, bbox_inches='tight')
        print(f"Saved: {safe_name}_training_accuracy.png")
        plt.close()
        
        # 2. Validation Accuracy for this model
        plt.figure(figsize=(10, 6))
        plt.plot(data['epochs'], data['val_accs'], 'r-', linewidth=3, marker='s', markersize=6)
        plt.title(f'{model_name} - Validation Accuracy', fontsize=16, fontweight='bold', pad=20)
        plt.xlabel('Epoch', fontsize=14)
        plt.ylabel('Validation Accuracy', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.ylim(0, 1)
        plt.tight_layout()
        plt.savefig(f'{safe_name}_validation_accuracy.png', dpi=300, bbox_inches='tight')
        print(f"Saved: {safe_name}_validation_accuracy.png")
        plt.close()
        
        # 3. Training Loss for this model
        plt.figure(figsize=(10, 6))
        plt.plot(data['epochs'], data['train_losses'], 'g-', linewidth=3, marker='^', markersize=6)
        plt.title(f'{model_name} - Training Loss', fontsize=16, fontweight='bold', pad=20)
        plt.xlabel('Epoch', fontsize=14)
        plt.ylabel('Training Loss', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.yscale('log')
        plt.tight_layout()
        plt.savefig(f'{safe_name}_training_loss.png', dpi=300, bbox_inches='tight')
        print(f"Saved: {safe_name}_training_loss.png")
        plt.close()
        
        # 4. Validation Loss for this model
        plt.figure(figsize=(10, 6))
        plt.plot(data['epochs'], data['val_losses'], 'm-', linewidth=3, marker='D', markersize=6)
        plt.title(f'{model_name} - Validation Loss', fontsize=16, fontweight='bold', pad=20)
        plt.xlabel('Epoch', fontsize=14)
        plt.ylabel('Validation Loss', fontsize=14)
        plt.grid(True, alpha=0.3)
        plt.yscale('log')
        plt.tight_layout()
        plt.savefig(f'{safe_name}_validation_loss.png', dpi=300, bbox_inches='tight')
        print(f"Saved: {safe_name}_validation_loss.png")
        plt.close()
        ...
        plt.title(f'{model_name} - Accuracy Comparison', fontsize=16, fontweight='bold', pad=20)
        plt.xlabel('Epoch', fontsize=14)
        plt.ylabel('Accuracy', fontsize=14)
        plt.legend(fontsize=12)
        plt.grid(True, alpha=0.3)
        plt.ylim(0, 1)
        plt.tight_layout()
        plt.savefig(f'{safe_name}_accuracy_comparison.png', dpi=300, bbox_inches='tight')
        print(f"Saved: {safe_name}_accuracy_comparison.png")
        plt.close()
        ...
        plt.title(f'{model_name} - Loss Comparison', fontsize=16, fontweight='bold', pad=20)
        plt.xlabel('Epoch', fontsize=14)
        ...
        plt.yscale('log')
        plt.tight_layout()
        plt.savefig(f'{safe_name}_loss_comparison.png', dpi=300, bbox_inches='tight')
        print(f"Saved: {safe_name}_loss_comparison.png")
        plt.close()

if __name__ == "__main__":
    print("Creating individual chart files...")
    
    print("\n1. Creating metric comparison charts...")
    model_data = create_individual_chart_files()
    
    print("\n2. Creating individual model charts...")
    create_individual_model_charts()
    
    print("\nAll individual chart files generated successfully!")
    print("\nGenerated files:")
    print("- 6 metric comparison charts (01-06)")
