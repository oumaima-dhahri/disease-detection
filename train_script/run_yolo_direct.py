...
def run_yolo_directly():
    """Run the existing yolo.py script directly"""
    ...
    print(f"🚀 Running {script_file} directly...")
    print("This script should work without conversion issues.")
    print("=" * 60)
